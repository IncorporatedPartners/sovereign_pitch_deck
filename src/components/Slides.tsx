...
const TeamBullet = ({ children }: { children: React.ReactNode }) => (
  <li className="grid grid-cols-[6px_1fr] gap-3 items-start">
    <span className="mt-[7px] h-1.5 w-1.5 rounded-full bg-[#F0EEE9]" />
    <span>{children}</span>
  </li>
);
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mt-6 flex-1 w-full">
      <div className="flex flex-col py-6 border-t border-[#F0EEE9]/20">
        ...
        <ul className="space-y-4 text-[13px] text-[#F0EEE9] font-medium leading-relaxed">
          <TeamBullet>Identified the structural gap between music's $54B ecosystem and sports' $500B � traced it to a missing competitive layer � and built the infrastructure to create it before raising a dollar</TeamBullet>
          <TeamBullet>LabelHead is live: scoring engine operational, Founding Season architecture complete, platform active. Built before the raise, not with it.</TeamBullet>
          <TeamBullet>Designed Sovereign as an intentional flywheel � competition generates data, content distributes it, the data compounds into a moat no competitor can replicate after the fact</TeamBullet>
          <TeamBullet>Columbia and USC graduate with formal training in finance, investment analysis, and market design � the same discipline he applies to platform architecture and incentive structures</TeamBullet>
        </ul>
      </div>
      <div className="flex flex-col py-6 border-t border-[#F0EEE9]/20">
        <div className="mb-6 flex gap-5 items-start">
        ...
        <ul className="space-y-4 text-[13px] text-[#F0EEE9] font-medium leading-relaxed">
          <TeamBullet>Built a twenty-year reputation at the intersection of artists, audiences, and culture, earning trusted access to the people and institutions that shape the music industry</TeamBullet>
          <TeamBullet>Directed and produced content for some of music's most influential artists, generating hundreds of millions of views and becoming a preferred creative partner to top labels including Universal Music Group and Warner Music Group</TeamBullet>
          <TeamBullet>Designed Brazen's creator ecosystem around direct talent relationships, audience access, and cultural proximity</TeamBullet>
          <TeamBullet>Creative partner to Future, Young Thug, Lil Baby, Gunna, Rod Wave, Moneybagg Yo, and other leading artists</TeamBullet>
        </ul>
      </div>
    </div>
  </SlideLayout>
